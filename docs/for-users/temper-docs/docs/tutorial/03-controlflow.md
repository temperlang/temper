...
method of `List`](../reference/types.md#type-Listed-method-map) (and see [issue#21](https://github.com/temperlang/temper/issues/21) for some
...
custom ways (see [issue#8](https://github.com/temperlang/temper/issues/8)). But for now, they already can easily be used as
...
each" imperative looping capability in the future (see [issue#20](https://github.com/temperlang/temper/issues/20)). Second, as
...
You can also match types by using `is` (and see [issue#25](https://github.com/temperlang/temper/issues/25) on exhaustiveness
checking):
...
Just not done yet (see [issue#3](https://github.com/temperlang/temper/issues/3)).
...
[issue#24](https://github.com/temperlang/temper/issues/24)). As for memory management itself, we'll discuss that later. It gets
