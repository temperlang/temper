...
See [issue#5](https://github.com/temperlang/temper/issues/5) and [issue#7](https://github.com/temperlang/temper/issues/7) for tracking issues on preventing reference
cycles in Temper.
...
(and see [issue#31](https://github.com/temperlang/temper/issues/31) for potential index types):
...
[issue#24](https://github.com/temperlang/temper/issues/24)).
