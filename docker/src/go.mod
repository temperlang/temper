module github.com/temperlang/temper-docker

go 1.23.5

replace (
	github.com/mtrmac/gpgme v0.1.3 => ./stub/gpgme
	github.com/temperlang/temper-docker v0.0.1 => ./
)
...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20230929003012-ebd87d4352d6 // indirect
